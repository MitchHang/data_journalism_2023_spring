...
```{r echo=FALSE}
census_api_key("3ad46e027fcfceff7f5ae8867c1618c439e44f13", install=TRUE)
```
...
**Answer** The state with the largest percentage growth from 2000 to 2010 is Nevada, with a 35.1% increase in population.
...
**Answer** The Maryland county with the highest median household income is Howard County, with an estimated income of $129,549.
...
**Answer** The headline should be "Howard County has highest estimated median household income in all of Maryland."
...
**Answer** Not really, Calvert County overlaps Montgomery County until the latter's left end.

Is the difference between Howard and everyone else significant? 
**Answer** Yes, Howard County is very much distant from all of the other counties on the chart.
...
**Answer** The jurisdictions with the largest increases in median income include Baltimore City, Allegany County and Calvert County. None of the counties had their median incomes fall from 2010 to 2021, although Caroline County had the smallest increase in median income.
...
**Answer** One question is "Which high school(s) with an enrollment of 100 students or more have the highest percentage of graduates? What is the median household income for their zip code?" It may be hard to determine the answer initially because the "estimate," "min," "max" and "moe" columns are somewhat unfamiliar at first, and it would be easier if they were labeled properly.
...
**Answer** The average household income for high schools that have 60% or more graduates immediately enrolling in college is roughly \$111,448.30, while the average household income for high schools with 40% or less graduates immediately enrolling in college is \$69,252.24.
...
**Answer** "Which counties in Maryland have the most number of schools that have 60% or more graduates? What about 40% or less graduates? What is the average household income?"
