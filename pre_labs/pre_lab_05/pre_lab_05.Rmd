...
**Answer** The column names look very odd, as they all begin with x followed by a series of numbers sometimes separated by an underscore.
...
**Answer** The column names still have the x-followed-by-number naming scheme, but their lengths are much shorter.
...
**Answer** We still need to remove the periods from the names of the jurisdictions.
