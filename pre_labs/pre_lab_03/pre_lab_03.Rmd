...
**Answer** There seem to be no parsing errors now.
...
**Answer** Both "Vendor Name" and "Date" are character (<chr>) type, while "Amount" is a double (<dbl>) type.
...
**Answer** It says that 547 zip codes do not have five characters, although I do think the codeblock is taking the zip codes and treating them as integers, since "2241" appears the most in the dataset when it should be formatted as "02241" instead.
...
**Answer** Some of the rows do not have their category (i.e., Loan or Grant) mentioned, plus one category is listed as "L."
...
**Answer** A majority of the data is comprised of grants, and there don't seem to be any blank fields from the dataset. However, the capitalization for the grantees are inconsistent, with some being in capitalized case, others being in all caps and some being a hybrid of the two.
...
**Answer** The headers in the dataset now become lowercase, and spaces between words have been replaced with underscores.
...
**Answer** 50 duplicates are possible, according to the dataset.
...
**Answer** The new dataframe has 17,740 rows.
...
**Answer** Another column titled "zip5" was added that takes the nine-digit ZIP codes found in the dataset and writes the first five digits from them; the original nine-digit ZIP codes are kept along with the others in the "zip_code" column.
...
**Answer** The ZIP code 21202	has received the most amount of money from the Maryland Tourism Board (worth $8,464,101.00).	
