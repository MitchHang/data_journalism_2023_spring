...
**Answer** There are integer (int), character, and double columns.
...
**Answer** The dataset contains the number for an object, two different numerical columns (one being a zip code + GEOID and the other being the zip code itself), the name for the zip code, the log/set it exists in, two columns for the length and area of the shape, and another column for geometry.
...
**Answer** The output is a map of Maryland with many divisions.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I just installed and loaded tigris, so there wasn't much notable output.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There are now multiple columns with information about several other counties in the U.S., including their latitude and longitude, as well as the number of the state they represent.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The dataset with all U.S. counties is now shortened to show only counties from Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is now a map of Maryland that is divided into shapes representing various counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We now have a map of Maryland that is divided into shapes representing its counties along with subdivisions representing the zip codes.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** It shows a table with rows representing Maryland zip codes and their number of foreclosures, as well as a row for "No Zip Code."
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Now the larger datatable that has all the Maryland zip codes has an added column showing the number of foreclosures.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The map with the counties and zip codes in Maryland is now colored on varying intensities, with the higest intensity located within Prince George's County.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** "md_county_notices" has a list of counties with their number of notices of intent to foreclose, while "md_county_population" has a list of counties with their corresponding GEOID and population.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The "md_county_population" dataset now has an added column for geometry.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This county shows the two tables for "md_county_population" and "md_county_notices." The name of the counties in the first table are longer (they have "Maryland" at the end) than in the other table.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The name of the column for the counties is now "county" with the names being shortened to "X County," alongside their population and geometry columns.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The previous table now has added columns for the counties' number of notices of intent to foreclose.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is now a column added with the rate of foreclosures per capita.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The map of Maryland counties is now colored based on the rate of foreclosures, with Charles County having the highest intensity/rate.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Same map as before, but the color scheme has changed from a gradient to five solid colors. Charles County still has the highest rate of foreclosure and is represented with a brighter color.
...
**Answer** Same map as before, but now there are four counties based on a logarithmic scale. Charles County still has the highest rate of foreclosure and is represented with a brighter color.
